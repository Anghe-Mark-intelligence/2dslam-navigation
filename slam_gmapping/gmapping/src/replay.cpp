...
main(int argc, char** argv)
{
    ...
    ("scan_topic",  <std::string>()->value("/scan") ,"topic that contains the laserScan in the rosbag")
    ("bag_filename", <std::string>()->required(), "ros bag filename") 
    ("seed", po::value<unsigned long int>()->default(0), "seed")
    ("max_duration_buffer", po::value<unsigned long int>()->default(99999), "max tf buffer duration")
